        ...
        <div className="rounded-3xl border border-neutral-200 bg-white p-6 shadow-sm sm:p-8">
          <div className="space-y-6 text-center">
            <div className="rounded-t-2xl bg-green-500 px-4 py-5 text-white">
              <p className="text-sm font-extrabold uppercase tracking-[0.2em] rounded-lg mx-16 py-2 bg-gray-800  text-white">
                Oferta limitada
              </p>
              <h3 className="mt-2 text-3xl font-extrabold sm:text-3xl">
                Entre Para O Time!
              </h3>
            </div>

            <div className="space-y-4">
              <p className="text-2xl font-bold uppercase text-neutral-700 sm:text-xl">
                De{" "}
                <span className="text-red-700 line-through">R$1099,60</span> por
              </p>

              <p className="text-xl font-bold uppercase text-neutral-700 sm:text-lg">
                Apenas 12x de
              </p>

              <p className="text-5xl font-black leading-none text-green-600 sm:text-5xl">
                R$29,02
              </p>
